...
<head>
    ...
    <title>
        Dashboard for Gambling (dot) Com
    </title>
    <!--     Fonts and icons     -->
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="d-flex flex-column h-100">
                                    <h2 class="font-weight-bolder mb-0">Affiliate Statistics</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card ">
                            <div class="card-header pb-0 p-3">
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-2">Affliates within 100km of the office</h6>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">Affiliate ID:</p>
                                                <h6 class="text-sm mb-0">{{$affiliate['affiliate_id']}}</h6>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">Name:</p>
                                                <h6 class="text-sm mb-0">{{$affiliate['name']}}</h6>
                                            </div>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <div class="col text-center">
                                                <p class="text-xs font-weight-bold mb-0">Distance:</p>
                                                <h6 class="text-sm mb-0">{{round($affiliate['distance'],2)}} KM</h6>
                                            </div>
                                        </td>
                                    </tr>
                                     @endforeach
